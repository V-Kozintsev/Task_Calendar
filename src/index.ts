...
export const currentButton: HTMLElement | null =
...
saveTaskForm?.addEventListener("submit", async (ev) => {
  ...
  if (editingTaskIndex !== null) {
    ...
    try {
      ...
      // Specify a generic error type or custom error type
      const error = e as Error; // Cast e to Error type
